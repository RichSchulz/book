...
\begin{frame}{The Framework: Exploration vs.\ Exploitation}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{Exploration} (Decentralized, Radical)
            \begin{itemize}
        ...
        \end{column}
        \begin{column}{0.48\textwidth}
            \textbf{Exploitation} (Centralized, Incremental)
            \begin{itemize}
...
\begin{frame}{The Rise of Europe: Decentralization as Engine}
    ...
    \begin{itemize}
        \item \textbf{Political fragmentation:} Hundreds of competing polities. Rulers who taxed too much lost productive subjects to rivals (e.g.\ Huguenot exodus from France, 1685)
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Napoleonic shock + Stein-Hardenberg reforms (1807--12): abolished serfdom, opened trades to all citizens
...
\begin{frame}{Discussion}
    \begin{center}
        ...
        \textit{Relatively few countries have successfully caught up. Germany, Japan, and South Korea managed it, but most didn't. What does Frey's framework say about why catch-up growth is so rare?}
    \end{center}
\end{frame}
...
\begin{frame}{America: The Innovation Powerhouse}
    ...
    \begin{itemize}
        ...
        \item \textbf{Constitution:} Patent clause enshrined innovation incentives from 1790
    ...
    \begin{itemize}
        ...
        \item More individualism \& willingness to deviate from norms and customs \& move
    \end{itemize}
\end{frame}
...
\begin{frame}{ARPA and the Internet: Decentralized Innovation in Practice}
    ...
    \begin{itemize}
        ...
        \item Avoided the risk of conformity \& groupthink due to peer review in academia
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item U-form hierarchies
                \item Khrushchev's Sovnarkhoz reform failed (1957-1964)
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \item Deng Xiaoping's reforms
                \item Regional decentralization $\Rightarrow$ local laboratories for experimentation
                \item M-form hierachies
                \item {\small 'Cat theory' as justification for allowing citizens to accumulate wealth and inequality to rise to cause the rising tide that lifted all the boats.}
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
\begin{frame}
    \begin{center}
         \begin{figure}
          \includegraphics[width=0.7\textwidth]{fig10.2.png}   
          \caption{GDP per capita growth in China and the (former) USSR, 1920–2010
Source: Maddison Project Database, version 2013. Bolt and van Zanden, “The Maddison Project.”}
         \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{The Dictator's Dilemma}
    ...
    \begin{itemize}
        ...
        \item Xi Jinping's recentralization: crackdowns on tech firms and universities
    \end{itemize}
...
\begin{frame}{Modern Stagnation: Not Just China}
    ...
    \begin{itemize}
        ...
        \item Start-ups favor acquisition-based exits
...
\begin{frame}{Epilogue: AI and Moravec's Paradox}
    ...
    \vspace{0.5em}
    \begin{center}
        \textit{How will AI interact with the dictator's dilemma and Hayek's knowledge problem?}
    \end{center}
\end{frame}
...
\begin{frame}{Critical Assessment: Strengths}
    \begin{itemize}
        ...
        \item \textbf{Ambitious scope:} Highly detailed accounts of events over 300 years in a coherent framework moving fluently between China, Europe, US, Japan, Russia 
        \item \textbf{Policy relevance:} Speaks directly to current debates on China, tech regulation, AI governance
        \item \textbf{Bridges literatures:} Connects Acemoglu \& Robinson, North \& Weingast, Hayek, Schumpeter, along with quotes from the likes of Kant, Humboldt, etc.
    \end{itemize}
\end{frame}
...
\begin{frame}{Critical Assessment: Potential Weaknesses}
    \begin{enumerate}
        ...
        \small How much decentralization is optimal? The framework is qualitative and thus hard to falsify or test precisely. (e.g., ARPA vs. Deng's China)

        \item \textbf{Geography, culture, and contingency:} \\
        \small How much is explained by institutions vs.\ geography, cultural differences, or demographics? (Diamond; Galor)
